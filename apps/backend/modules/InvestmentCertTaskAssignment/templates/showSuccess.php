...
<a href="<?php echo url_for('InvestmentCertTaskAssignment/edit?id='.$task_assignment->getId()) ?>">Edit</a>
&nbsp;
<a href="<?php echo url_for('InvestmentCertTaskAssignment/index') ?>">List</a>
