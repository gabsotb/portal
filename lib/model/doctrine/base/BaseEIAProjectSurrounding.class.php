 ...
 * @property string $site_conform_approval
 ...
 * @property string $watershed_existing_remark
 * @property string $watershed_near_name
...
abstract class BaseEIAProjectSurrounding extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('site_conform_approval', 'string', 255, array(
             'type' => 'string',
             'notnull' => false,
             'length' => 255,
             ));
        ...
        $this->hasColumn('watershed_existing_remark', 'string', 255, array(
             'type' => 'string',
             'notnull' => false,
             'length' => 255,
             ));
        $this->hasColumn('watershed_near_name', 'string', 255, array(
             'type' => 'string',
             'notnull' => false,
             'length' => 255,
             ));
