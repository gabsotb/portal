 ...
 * @method financialstructure    setBusinessPlan()          Sets the current record's "business_plan" value
 * @method financialstructure    setLocalSource()           Sets the current record's "local_source" value
 * @method financialstructure    setForeignSource()         Sets the current record's "foreign_source" value
 * @method financialstructure    setInvestmentApplication() Sets the current record's "InvestmentApplication" value
 * 
 * @package    rdbeportal
 * @subpackage model
 ...
 */
abstract class Basefinancialstructure extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('financialstructure');
