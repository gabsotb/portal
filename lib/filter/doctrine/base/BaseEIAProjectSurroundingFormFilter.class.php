...
abstract class BaseEIAProjectSurroundingFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'project_general_elevation_remark' => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'project_general_elevation_remark' => new sfValidatorPass(array('required' => false)),
  ...
  public function getFields()
  {
    return array(
      ...
      'project_general_elevation_remark' => 'Text',
