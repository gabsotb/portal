...
abstract class BaseEIAProjectSurroundingFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'site_conform_approval'         => new sfWidgetFormChoice(array('choices' => array('' => 'yes or no', 1 => 'yes', 0 => 'no'))),
      ...
      'watershed_near_distance'       => new sfWidgetFormFilterInput(),
      'watershed_near_distance_units' => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'project_general_elevation'     => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      ...
      'site_conform_approval'         => new sfValidatorChoice(array('required' => false, 'choices' => array('', 1, 0))),
      ...
      'watershed_near_distance'       => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      'watershed_near_distance_units' => new sfValidatorPass(array('required' => false)),
  ...
  public function getFields()
  {
    return array(
      ...
      'project_general_elevation'     => 'Number',
      ...
      'watershed_near_distance'       => 'Number',
