...
abstract class BaseEIAProjectDescriptionFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'solid_waste_ecological'              => new sfWidgetFormChoice(array('choices' => array('' => 'yes or no', 1 => 'yes', 0 => 'no'))),
    ...
    $this->setValidators(array(
      ...
      'solid_waste_ecological'              => new sfValidatorChoice(array('required' => false, 'choices' => array('', 1, 0))),
  ...
  public function getFields()
  {
    return array(
      ...
      'solid_waste_ecological'              => 'Boolean',
