...
/**
 * EIApplicationCertificatePermission filter form base class.
 *
 * @package    rdbeportal
 * @subpackage filter
 ...
 */
abstract class BaseEIApplicationCertificatePermissionFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'send_to'     => new sfWidgetFormFilterInput(array('with_empty' => false)),
    ...
    $this->setValidators(array(
      'send_to'     => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
    ...
    $this->widgetSchema->setNameFormat('ei_application_certificate_permission_filters[%s]');
