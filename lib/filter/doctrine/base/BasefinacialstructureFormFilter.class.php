...
/**
 * finacialstructure filter form base class.
 *
 * @package    rdbeportal
 * @subpackage filter
 ...
 */
abstract class BasefinacialstructureFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'foreign'       => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'foreign'       => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
    ...
    $this->widgetSchema->setNameFormat('finacialstructure_filters[%s]');
