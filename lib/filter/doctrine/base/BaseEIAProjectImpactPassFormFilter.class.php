...
/**
 * EIAProjectImpactPass filter form base class.
 *
 * @package    rdbeportal
 * @subpackage filter
 ...
 */
abstract class BaseEIAProjectImpactPassFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'letter_status' => new sfWidgetFormFilterInput(array('with_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'letter_status' => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
    ...
    $this->widgetSchema->setNameFormat('eia_project_impact_pass_filters[%s]');
