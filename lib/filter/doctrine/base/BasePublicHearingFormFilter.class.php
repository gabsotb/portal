...
/**
 * PublicHearing filter form base class.
 *
 * @package    rdbeportal
 * @subpackage filter
 ...
 */
abstract class BasePublicHearingFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('public_hearing_filters[%s]');
