...
/**
 * Startupexpenses filter form base class.
 *
 * @package    rdbeportal
 * @subpackage filter
 ...
 */
abstract class BaseStartupexpensesFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('startupexpenses_filters[%s]');
