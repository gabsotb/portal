...
abstract class BaseEIAProjectSocialEconomicFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'livelihood_remarks'             => new sfWidgetFormFilterInput(),
      ...
      'social_schools'                 => new sfWidgetFormChoice(array('choices' => array('' => 'yes or no', 1 => 'yes', 0 => 'no'))),
    ...
    $this->setValidators(array(
      ...
      'livelihood_remarks'             => new sfValidatorPass(array('required' => false)),
      ...
      'social_schools'                 => new sfValidatorChoice(array('required' => false, 'choices' => array('', 1, 0))),
