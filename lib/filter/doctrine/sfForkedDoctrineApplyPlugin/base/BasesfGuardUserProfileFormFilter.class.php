...
abstract class BasesfGuardUserProfileFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'salutation'   => new sfWidgetFormFilterInput(array('with_empty' => false)),
      'citizenship'  => new sfWidgetFormFilterInput(array('with_empty' => false)),
      ...
      'id_passport'  => new sfWidgetFormFilterInput(array('with_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'id_passport'  => new sfValidatorPass(array('required' => false)),
