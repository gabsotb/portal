...
/**
 * EIApplicationDecision form base class.
 *
 * @method EIApplicationDecision getObject() Returns the current form's model object
 *
 * @package    rdbeportal
 * @subpackage form
 ...
 */
abstract class BaseEIApplicationDecisionForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ei_application_decision[%s]');
