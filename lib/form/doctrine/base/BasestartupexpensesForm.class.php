...
/**
 * Startupexpenses form base class.
 *
 * @method Startupexpenses getObject() Returns the current form's model object
 *
 * @package    rdbeportal
 * @subpackage form
 ...
 */
abstract class BaseStartupexpensesForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('startupexpenses[%s]');
