...
/**
 * TechnicalSummary form base class.
 *
 * @method TechnicalSummary getObject() Returns the current form's model object
 *
 * @package    rdbeportal
 * @subpackage form
 ...
 */
abstract class BaseTechnicalSummaryForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('technical_summary[%s]');
