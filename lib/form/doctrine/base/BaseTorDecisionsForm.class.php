...
/**
 * TorDecisions form base class.
 *
 * @method TorDecisions getObject() Returns the current form's model object
 *
 * @package    rdbeportal
 * @subpackage form
 ...
 */
abstract class BaseTorDecisionsForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'decision'   => new sfValidatorString(array('max_length' => 100)),
    ...
    $this->widgetSchema->setNameFormat('tor_decisions[%s]');
