...
abstract class BaseEIAProjectSocialEconomicForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'average_family_size_remark'     => new sfWidgetFormInputText(),
      ...
      'livelihood_others_specify'      => new sfWidgetFormInputText(),
      'local_organization'             => new sfWidgetFormInputCheckbox(),
      'local_organization_description' => new sfWidgetFormInputText(),
      ...
      'social_others_specify'          => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'average_family_size_remark'     => new sfValidatorString(array('max_length' => 255, 'required' => false)),
      ...
      'livelihood_others_specify'      => new sfValidatorString(array('max_length' => 255, 'required' => false)),
      'local_organization'             => new sfValidatorBoolean(array('required' => false)),
      'local_organization_description' => new sfValidatorString(array('max_length' => 255, 'required' => false)),
      ...
      'social_others_specify'          => new sfValidatorString(array('max_length' => 255, 'required' => false)),
