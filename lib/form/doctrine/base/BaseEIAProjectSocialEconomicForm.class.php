...
abstract class BaseEIAProjectSocialEconomicForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'existing_settlements_remark'    => new sfValidatorString(array('max_length' => 2000, 'required' => false)),
      'average_family_size'            => new sfValidatorInteger(array('required' => false)),
      'average_family_size_remark'     => new sfValidatorString(array('max_length' => 2000, 'required' => false)),
      ...
      'livelihood_others_specify'      => new sfValidatorString(array('max_length' => 3000, 'required' => false)),
      'livelihood_remarks'             => new sfValidatorString(array('max_length' => 2000, 'required' => false)),
      'local_organization'             => new sfValidatorBoolean(array('required' => false)),
      'local_organization_description' => new sfValidatorString(array('max_length' => 2000, 'required' => false)),
      ...
      'social_others_specify'          => new sfValidatorString(array('max_length' => 2000, 'required' => false)),
