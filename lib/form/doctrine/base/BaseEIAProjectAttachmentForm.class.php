...
abstract class BaseEIAProjectAttachmentForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'location_area_map'         => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'location_area_map'         => new sfValidatorString(array('max_length' => 255, 'required' => false)),
      'other_supporting_document' => new sfValidatorString(array('max_length' => 255, 'required' => false)),
      'project_reference_number'  => new sfValidatorString(array('max_length' => 255, 'required' => false)),
