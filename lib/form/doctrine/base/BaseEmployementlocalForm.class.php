...
/**
 * Employementlocal form base class.
 *
 * @method Employementlocal getObject() Returns the current form's model object
 *
 * @package    rdbeportal
 * @subpackage form
 ...
 */
abstract class BaseEmployementlocalForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('employementlocal[%s]');
