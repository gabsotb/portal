...
abstract class BaseBusinessPlanForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'executive_summary'   => new sfValidatorString(array('max_length' => 4000)),
      'promoter_profile'    => new sfValidatorString(array('max_length' => 4000)),
      'project_background'  => new sfValidatorString(array('max_length' => 4000)),
      'equity_financing'    => new sfValidatorString(array('max_length' => 4000)),
      'income_statement'    => new sfValidatorString(array('max_length' => 4000)),
      'cashflow_statement'  => new sfValidatorString(array('max_length' => 4000)),
      'payback_period'      => new sfValidatorString(array('max_length' => 4000)),
      'npv'                 => new sfValidatorString(array('max_length' => 4000)),
      'loan_amortization'   => new sfValidatorString(array('max_length' => 4000)),
      'implementation_plan' => new sfValidatorString(array('max_length' => 4000)),
      'notes'               => new sfValidatorString(array('max_length' => 4000)),
