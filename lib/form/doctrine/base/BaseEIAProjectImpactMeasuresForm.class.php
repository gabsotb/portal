...
abstract class BaseEIAProjectImpactMeasuresForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'dust_generation_remarks'                    => new sfWidgetFormTextarea(),
      ...
      'soil_removal_remarks'                       => new sfWidgetFormTextarea(),
      ...
      'erosion_remarks'                            => new sfWidgetFormTextarea(),
      ...
      'sedimentation_remarks'                      => new sfWidgetFormTextarea(),
      ...
      'pollution_remarks'                          => new sfWidgetFormTextarea(),
      ...
      'vegetation_remarks'                         => new sfWidgetFormTextarea(),
      ...
      'disturbance_remarks'                        => new sfWidgetFormTextarea(),
    ...
    $this->setValidators(array(
      ...
      'dust_generation_remarks'                    => new sfValidatorString(array('max_length' => 2000, 'required' => false)),
      ...
      'soil_removal_remarks'                       => new sfValidatorString(array('max_length' => 2000, 'required' => false)),
      ...
      'erosion_remarks'                            => new sfValidatorString(array('max_length' => 2000, 'required' => false)),
      ...
      'sedimentation_remarks'                      => new sfValidatorString(array('max_length' => 2000, 'required' => false)),
      ...
      'pollution_remarks'                          => new sfValidatorString(array('max_length' => 2000, 'required' => false)),
      ...
      'vegetation_remarks'                         => new sfValidatorString(array('max_length' => 2000, 'required' => false)),
      ...
      'disturbance_remarks'                        => new sfValidatorString(array('max_length' => 2000, 'required' => false)),
      ...
      'noise_generation_remark'                    => new sfValidatorString(array('max_length' => 2000, 'required' => false)),
      ...
      'generation_employment_remarks'              => new sfValidatorString(array('max_length' => 2000, 'required' => false)),
      'conflicts'                                  => new sfValidatorBoolean(array('required' => false)),
      'conflict_conslutation'                      => new sfValidatorBoolean(array('required' => false)),
      'conflict_remarks'                           => new sfValidatorString(array('max_length' => 2000, 'required' => false)),
      ...
      'traffic_congestion_remarks'                 => new sfValidatorString(array('max_length' => 2000, 'required' => false)),
      ...
      'crime_accidents_remarks'                    => new sfValidatorString(array('max_length' => 1000, 'required' => false)),
