...
abstract class BaseEIAProjectSurroundingForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'project_general_elevation_remark' => new sfWidgetFormInputText(),
      ...
      'site_conform_approval'            => new sfWidgetFormInputText(),
      ...
      'watershed_existing_remark'        => new sfWidgetFormInputText(),
      'watershed_near_name'              => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'project_general_elevation'        => new sfValidatorString(array('max_length' => 255, 'required' => false)),
      'project_general_elevation_remark' => new sfValidatorString(array('max_length' => 255, 'required' => false)),
      ...
      'site_conform_approval'            => new sfValidatorString(array('max_length' => 255, 'required' => false)),
      ...
      'watershed_existing_remark'        => new sfValidatorString(array('max_length' => 255, 'required' => false)),
      'watershed_near_name'              => new sfValidatorString(array('max_length' => 255, 'required' => false)),
