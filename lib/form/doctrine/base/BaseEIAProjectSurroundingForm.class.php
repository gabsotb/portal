...
abstract class BaseEIAProjectSurroundingForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'existing_trees_remark'         => new sfWidgetFormTextarea(),
      'wildlife_existing'             => new sfWidgetFormInputCheckbox(),
      'wildlife_existing_remark'      => new sfWidgetFormTextarea(),
      'fishery_existing'              => new sfWidgetFormInputCheckbox(),
      'fishery_existing_remark'       => new sfWidgetFormTextarea(),
      ...
      'watershed_within_name'         => new sfWidgetFormTextarea(),
    ...
    $this->setValidators(array(
      ...
      'soil_erosion_others_specify'   => new sfValidatorString(array('max_length' => 2000, 'required' => false)),
      'existing_water_body'           => new sfValidatorBoolean(array('required' => false)),
      'existing_water_body_remark'    => new sfValidatorString(array('max_length' => 2000, 'required' => false)),
      'access_road'                   => new sfValidatorBoolean(array('required' => false)),
      'access_road_distance'          => new sfValidatorInteger(array('required' => false)),
      'access_road_type'              => new sfValidatorString(array('max_length' => 2000, 'required' => false)),
      'site_conform_approval'         => new sfValidatorBoolean(array('required' => false)),
      'site_conform_remark'           => new sfValidatorString(array('max_length' => 2000, 'required' => false)),
      'site_existing_structure'       => new sfValidatorBoolean(array('required' => false)),
      'site_existing_remark'          => new sfValidatorString(array('max_length' => 2000, 'required' => false)),
      ...
      'land_use_other_specify'        => new sfValidatorString(array('max_length' => 2000, 'required' => false)),
      'existing_trees'                => new sfValidatorBoolean(array('required' => false)),
      'existing_trees_remark'         => new sfValidatorString(array('max_length' => 2000, 'required' => false)),
      'wildlife_existing'             => new sfValidatorBoolean(array('required' => false)),
      'wildlife_existing_remark'      => new sfValidatorString(array('max_length' => 2000, 'required' => false)),
      'fishery_existing'              => new sfValidatorBoolean(array('required' => false)),
      'fishery_existing_remark'       => new sfValidatorString(array('max_length' => 2000, 'required' => false)),
      ...
      'watershed_within_name'         => new sfValidatorString(array('max_length' => 2000, 'required' => false)),
