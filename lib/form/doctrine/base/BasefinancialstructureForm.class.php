...
/**
 * financialstructure form base class.
 *
 * @method financialstructure getObject() Returns the current form's model object
 *
 * @package    rdbeportal
 * @subpackage form
 ...
 */
abstract class BasefinancialstructureForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('financialstructure[%s]');
