...
abstract class BaseEIAProjectSurroundingSpeciesForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'birds_animals'          => new sfWidgetFormTextarea(),
      'trees_vegetation'       => new sfWidgetFormTextarea(),
      'fisheries'              => new sfWidgetFormTextarea(),
    ...
    $this->setValidators(array(
      ...
      'birds_animals'          => new sfValidatorString(array('max_length' => 5000, 'required' => false)),
      'trees_vegetation'       => new sfValidatorString(array('max_length' => 5000, 'required' => false)),
      'fisheries'              => new sfValidatorString(array('max_length' => 5000, 'required' => false)),
