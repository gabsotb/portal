...
abstract class BaseEIAProjectDescriptionForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'project_objective'                   => new sfValidatorString(array('max_length' => 1000)),
      'project_total_cost'                  => new sfValidatorInteger(),
      'project_working_capital'             => new sfValidatorInteger(),
      'total_land_area'                     => new sfValidatorInteger(),
      'existing_land_use'                   => new sfValidatorString(array('max_length' => 255, 'required' => false)),
      ...
      'sewage_system_other_specify'         => new sfValidatorString(array('max_length' => 400, 'required' => false)),
