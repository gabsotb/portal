...
$response = $this->context->getResponse();
  ...
  $response->addStylesheet('assets/tabletools/TableTools.css', '', array ());
  ...
  $response->addJavascript('highcharts/highcharts.js', '', array ());
  $response->addJavascript('highcharts/exporting.js', '', array ());
  ...
  $response->addJavascript('assets/js/ZeroClipboard.js', '', array ());
  $response->addJavascript('assets/js/TableTools.js', '', array ());
