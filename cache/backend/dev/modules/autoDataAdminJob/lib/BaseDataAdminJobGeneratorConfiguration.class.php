 ...
 */
abstract class BaseDataAdminJobGeneratorConfiguration extends sfModelGeneratorConfiguration
{
  ...
  {
    return '%%id%% - %%user_assigned%% - %%investmentapp_id%% - %%instructions%% - %%duedate%% - %%work_status%% - %%created_at%% - %%updated_at%% - %%created_by%% - %%updated_by%%';
  }
  ...
  {
    return 'DataAdminJob List';
  }

  public function getEditTitle()
  {
    return 'Edit Job Assigned To %%investmentapp_id%%';
  }
  ...
  {
    return array(  0 => 'id',  1 => 'user_assigned',  2 => 'investmentapp_id',  3 => 'instructions',  4 => 'duedate',  5 => 'work_status',  6 => 'created_at',  7 => 'updated_at',  8 => 'created_by',  9 => 'updated_by',);
  }
